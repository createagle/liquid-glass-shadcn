...
//
// ✅ **填充色后来成了 token。** 这里实测的 rgb(0 136 255) 当时不敢采信
//    （怀疑是 Display P3 → sRGB 的色彩管理差异），只留了一条告警。
//    后来又有三份互相独立的资源量到逐位相同的值（macOS 控件、iOS 日期格、
//    macOS 搜索框光标）—— 四份不可能是同一个色彩管理误差，
//    `--lg-blue` 已改成 #0088ff。填充照旧走 --lg-blue，现在两者相等。
//
