...
**下一步是 P2。** 建议的头四个仍然是
`Accordion` / `Collapsible` / `Scroll Area` / `Table`：
它们都是内容层（Table 更是 SPEC 明令禁止堆玻璃），
而 Scroll Area 正好能复用 Hero 那批做的滚动边缘效果。
...
| **Table** | `207:14499 Lists and Tables` | P2 要做，且 SPEC 对它有硬约束 |
| **Progress** | `207:14486 Progress Indicators` | §0.71 记着它的几何「全是借来的」 |
| **Toolbar / Sidebar** | `207:14501` / `207:14495` | apple-metrics §11 列为「仍缺」 |
