...
Phase 4 的核心原语已落地；Phase 6 的任务卡 7 项里完成 6 项。**
...
| **文档站**（Phase 6 三批） | 任务卡 7 项里的 1 · 2 · 3 · 4 · 6 · 7 |

### Phase 6 只剩一项：**首页 Hero**

任务卡第 5 位：「首页 Hero：一个**完全可交互**的 iOS 风格界面」。
现在的首页只是普通落地页。规格的意思是 tab bar + segmented + slider 全都是活的 ——
本库刚好有 Tabs / Slider / Switch / Card，材料齐了。

做完这一项，Phase 6 的任务卡就走完了。之后还欠（都不在任务卡的 7 项里）：
Themes / Playground、Theming / Dark Mode / CLI / Registry 四页、代码块语法高亮。
